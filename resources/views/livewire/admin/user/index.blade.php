                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span>
                                <a href="#" wire:click="passwordRecord({{ $user->id }})" class="btn btn-icon btn-square btn-outline-info list-button" data-toggle="modal" data-target="#changePasswordModal"><i class="fa fa-key"></i></a>
                            </span>
                            <span>
                            ...
                            @include('modal.admin.chnagePassword')
                        </td>
                    </tr>
                    @empty
                    <tr>
