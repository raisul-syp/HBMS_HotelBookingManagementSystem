        ...
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Slider') }}</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Slider List') }}</a></li>
                </ol>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <a href="{{ url('admin/website/slider/create') }}" class="btn btn-success text-white mr-1">{{ __('Add Slider') }}</a>
        </div>
    </div>
