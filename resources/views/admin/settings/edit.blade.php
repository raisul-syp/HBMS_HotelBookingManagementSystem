                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane fade active show" id="settings_info" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="google_map" id="google_map" rows="3" placeholder="Add Google Map Key...">{{ $settings->google_map }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" id="phone_sales" name="phone_sales" value="{{ $settings->phone_sales }}" placeholder="Add Phone (Sales)...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" id="phone_reservation" name="phone_reservation" value="{{ $settings->phone_reservation }}" placeholder="Add Phone (Reservation)...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" id="email_sales" name="email_sales" value="{{ $settings->email_sales }}" placeholder="Add Email (Sales)...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" id="email_reservation" name="email_reservation" value="{{ $settings->email_reservation }}" placeholder="Add Email (Reservation)...">
                                        </div>
                                    </div>
                                </div>
                            </div>
