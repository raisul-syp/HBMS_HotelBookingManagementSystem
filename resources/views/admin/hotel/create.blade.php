...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Create A New Hotel') }}</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Hotels') }}</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Add Hotel') }}</a></li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/hotels') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#hotel_info">
                                    <span>
                                        <strong>
                                            <i class="ti-info"></i>
                                            <span class="ml-2">{{ __('Hotel Info') }}</span>
                                        </strong>
                                    </span>
                                </a>
                            </li>
